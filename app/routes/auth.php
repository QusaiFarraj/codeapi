...
//activate
$app->get("/activate", "UserController:activate")->setName("activate");
$app->get("/activate/resend", "UserController:resendActivation")->setName("activate.resend");
...
// Password Reset
$app->get("/password-reset", "UserController:resetPassword")->setName("password.reset");
$app->post("/password-reset", "UserController:resetPassword")->setName('password.reset.post');
